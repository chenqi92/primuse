...
public enum WiFiTransferPage {
    public static let english: [String: String] = [
        ...
        "sessionHint": "Keep this transfer screen open until the transfer finishes.",
