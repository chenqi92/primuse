...
- `00-soft-note.png` — primary icon: a cream dimensional eighth note with a soft cast shadow, on a mint-to-aqua gradient.
...
- `17-splash.png` — the previous primary icon, retained as an alternate: a milky-white dimensional splash with an engraved ring and a note in its opening, on solid berry pink.
