...
The source inputs live in `raw/`. `00-folded-note*.png`, `06-soft-note*.png`, and `09-classic-record*.png` preserve their exact artwork. `07-primuse-mark*.png` and `11-color-brush*.png` are deterministic outputs refreshed by the generator.
